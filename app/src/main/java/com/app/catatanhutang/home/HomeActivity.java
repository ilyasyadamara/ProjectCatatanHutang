...
import com.app.catatanhutang.create.CreateActivity;
import com.app.catatanhutang.edit.EditDialogFragment;
import com.app.catatanhutang.utils.FunctionHelper;
...
public class HomeActivity extends AppCompatActivity
    ...
    private void showDialogDelete(final int position, String name){
        ...
        builder1.setMessage("Yakin untuk menghapus hutang "+ name + " ?");
